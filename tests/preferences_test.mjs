...
assert.deepEqual(sanitizePreferences({penBackground:'white',showHover:true,showDebugLog:true,hideCursor:true,resolutionScale:'0.5'}),{penBackground:'white',showHover:true,showDebugLog:true,hideCursor:true,resolutionScale:'0.5'});
assert.deepEqual(sanitizePreferences({penBackground:'blue',showHover:1,showDebugLog:'off',hideCursor:'no',activeAreaScale:'0.8',resolutionScale:'2'}),{});
