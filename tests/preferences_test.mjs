...
assert.deepEqual(sanitizePreferences({penBackground:'white',showActiveArea:false,showHover:true}),{penBackground:'white',showActiveArea:false,showHover:true});
assert.deepEqual(sanitizePreferences({penBackground:'blue',showActiveArea:'yes',showHover:1}),{});
console.log('7 preference validation checks passed');
