export function sanitizePreferences(value) {
  ...
  const result={};
  const options={mode:['pen','mirror','extend'],mapping:['preserve','stretch'],fps:['30','60'],quality:['fast','balanced','high'],pressureCurve:['linear','soft','firm']};
  ...
  // Deliberately do not restore target identity, input authorization or touch.
  return result;
}
